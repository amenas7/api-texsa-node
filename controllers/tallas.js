...
const getTallas = async(req, res) => {
    ...
    try {
        const obtenerRegistros = await consultar_datos_tallas(req, res);
        ...
        const p_tallas = await consultar_total_tallas(req, res);
...
function consultar_datos_tallas(req, res) {
    const query = `
    SELECT tallaID, descripcion_talla
        from talla
        ORDER BY tallaID DESC `;
...
function consultar_total_tallas(req, res) {
    const query = `
    SELECT * FROM talla ORDER BY tallaID DESC `;
